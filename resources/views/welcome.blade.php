...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                    <div class="text-center mb-8">
                        <h1 class="mb-4 font-medium text-3xl text-[#1b1b18] dark:text-[#EDEDEC]">Sistem Absensi RFID</h1>
                        <p class="mb-6 text-[#706f6c] dark:text-[#A1A09A] text-base">Silakan scan kartu RFID Anda untuk mencatat kehadiran hari ini.</p>
                        ...
                        <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg">
                            ...
                            <ol class="text-left text-blue-700 dark:text-blue-300 space-y-2">
                                <li class="flex items-start">
                                    <span class="inline-block w-6 h-6 bg-blue-500 text-white rounded-full text-center text-sm font-bold mr-3 mt-0.5">1</span>
                                    <span>Dekatkan kartu RFID Anda ke papan reader</span>
                                </li>
                                <li class="flex items-start">
                                    <span class="inline-block w-6 h-6 bg-blue-500 text-white rounded-full text-center text-sm font-bold mr-3 mt-0.5">2</span>
                                    <span>Tunggu hingga terdengar bunyi "beep" dari reader</span>
                                </li>
                                <li class="flex items-start">
                                    <span class="inline-block w-6 h-6 bg-blue-500 text-white rounded-full text-center text-sm font-bold mr-3 mt-0.5">3</span>
                    ...
                    <div id="modal-overlay" class="fixed inset-0 bg-black bg-opacity-50 z-50 items-center justify-center" style="display: none;">
                        <div id="modal-content" class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 mx-4 max-w-md w-full transform scale-95 transition-all duration-300">
                    ...
                    <form action="{{ route('attendance.store') }}" method="POST" class="space-y-6">
                        ...
                        <!-- Status Indicator -->
                        <div id="status-indicator" class="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Auto-submit setelah delay (untuk RFID reader yang tidak mengirim Enter)
                let timeout;
                rfidInput.addEventListener('input', function() {
                    clearTimeout(timeout);
                    if (rfidInput.value.trim()) {
                        timeout = setTimeout(function() {
                            if (rfidInput.value.trim() && !form.classList.contains('submitting')) {
                        ...
                        }, 1500); // Auto-submit setelah 1.5 detik
                    }
                });
